...
namespace Db.BL
{
    internal class BLStudent
    {
        ...
        public List<BLSubject> registerSub = new List<BLSubject>();
        ...
        public BLStudent(string name, int age, float fSCMarks, float ecatMarks, float merit, List<BLDegreeProgram> degreePreferances, List<BLSubject> registerSub)
        {
            this.merit = merit;
