...
UPDATE employees SET dob = '1938-12-18' WHERE employee_id = 100;
UPDATE employees SET dob = '1971-01-01' WHERE employee_id = 101;
UPDATE employees SET dob = '2024-07-19' WHERE employee_id = 102;
UPDATE employees SET dob = '1975-09-05' WHERE employee_id = 103;
UPDATE employees SET dob = '1983-12-09' WHERE employee_id = 104;
UPDATE employees SET dob = '1942-12-22' WHERE employee_id = 105;
UPDATE employees SET dob = '2014-07-28' WHERE employee_id = 106;
UPDATE employees SET dob = '1935-04-04' WHERE employee_id = 107;
UPDATE employees SET dob = '1983-01-24' WHERE employee_id = 108;
UPDATE employees SET dob = '1943-12-25' WHERE employee_id = 109;
UPDATE employees SET dob = '2001-08-13' WHERE employee_id = 110;
UPDATE employees SET dob = '1934-07-26' WHERE employee_id = 111;
UPDATE employees SET dob = '2007-10-19' WHERE employee_id = 112;
UPDATE employees SET dob = '1956-08-16' WHERE employee_id = 113;
UPDATE employees SET dob = '1932-02-12' WHERE employee_id = 114;
UPDATE employees SET dob = '1930-12-11' WHERE employee_id = 115;
UPDATE employees SET dob = '1934-05-28' WHERE employee_id = 116;
UPDATE employees SET dob = '1964-04-08' WHERE employee_id = 117;
UPDATE employees SET dob = '1973-04-25' WHERE employee_id = 118;
UPDATE employees SET dob = '2018-07-05' WHERE employee_id = 119;
UPDATE employees SET dob = '1971-11-30' WHERE employee_id = 120;
UPDATE employees SET dob = '2004-11-13' WHERE employee_id = 121;
UPDATE employees SET dob = '2008-03-10' WHERE employee_id = 122;
UPDATE employees SET dob = '1999-04-07' WHERE employee_id = 123;
UPDATE employees SET dob = '1934-08-16' WHERE employee_id = 126;
UPDATE employees SET dob = '2005-11-24' WHERE employee_id = 145;
UPDATE employees SET dob = '1958-05-01' WHERE employee_id = 146;
UPDATE employees SET dob = '2018-06-01' WHERE employee_id = 176;
UPDATE employees SET dob = '1950-03-28' WHERE employee_id = 177;
UPDATE employees SET dob = '2016-08-07' WHERE employee_id = 178;
UPDATE employees SET dob = '1992-01-26' WHERE employee_id = 179;
UPDATE employees SET dob = '1963-03-18' WHERE employee_id = 192;
UPDATE employees SET dob = '2001-09-14' WHERE employee_id = 193;
UPDATE employees SET dob = '1964-05-12' WHERE employee_id = 200;
UPDATE employees SET dob = '1956-09-21' WHERE employee_id = 201;
UPDATE employees SET dob = '2024-08-28' WHERE employee_id = 202;
UPDATE employees SET dob = '1971-08-07' WHERE employee_id = 203;
UPDATE employees SET dob = '1966-10-07' WHERE employee_id = 204;
UPDATE employees SET dob = '1979-01-07' WHERE employee_id = 205;
UPDATE employees SET dob = '1987-05-24' WHERE employee_id = 206;